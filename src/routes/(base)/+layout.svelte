...
<div class="sticky top-0 px-6 text-xl text-stone-500 w-full backdrop-blur border-b z-20">
  <div class="py-4 pr-4 flex justify-between items-center">
    ...
    <a href="https://github.com/rgossiaux/svelte-headlessui" class="hover:text-black">
